...
"""Internal static anchored PDF-to-DOCX conversion helper.

This is intentionally not wired into the public pdf2docx CLI.
"""
...
from pdf2docx.static_anchored import convert_static_anchored_pdf
